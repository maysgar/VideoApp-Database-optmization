CREATE OR REPLACE PACKAGE PKG_COSTES AS
 ...
 PROCEDURE PR_WORKLOAD(N NUMBER) IS
	...
	FROM CONTRACTS
	 ...
	 INSERT INTO taps_movies VALUES(a.clientId, threeHoursLess, 27, 'Titanic'); --movies insertion

	 INSERT INTO taps_series VALUES(a.clientId, threeHoursLess, 27, 'House', 1, 1); --'Game of Thrones', 3, 1  -- first series insertion

	 INSERT INTO taps_series VALUES(a.clientId, threeHoursLess, 27, 'Sherlock', 1, 1); --'Game of Thrones', 4, 1 -- second series insertion

	 INSERT INTO taps_series VALUES(a.clientId, threeHoursLess, 27, 'Columbus', 1, 1); --'Game of Thrones', 1, 1 -- third series insertion
	...
	FROM CONTRACTS
	 WHERE  ENDDATE>SYSDATE OR ENDDATE IS NULL
	  ...
	  DELETE FROM TAPS_SERIES WHERE b.CONTRACTID= CONTRACTID AND b.PCT= 27 AND b.TITLE= 'House' AND b.SEASON= 1 AND b.EPISODE= 1;

	  DELETE FROM TAPS_SERIES WHERE b.CONTRACTID= CONTRACTID AND b.PCT= 27 AND b.TITLE= 'Sherlock' AND b.SEASON= 1 AND b.EPISODE= 1;

	  DELETE FROM TAPS_SERIES WHERE b.CONTRACTID= CONTRACTID AND b.PCT= 27 AND b.TITLE= 'Columbus' AND b.SEASON= 1 AND b.EPISODE= 1;
